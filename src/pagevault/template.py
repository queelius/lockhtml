"""Template generation for pagevault.

Provides functions to generate standalone JavaScript and CSS files
for the pagevault Web Component, useful for advanced customization.
"""
...
def generate_css(config: PagevaultConfig | None = None) -> str:
...
def generate_javascript(config: PagevaultConfig | None = None) -> str:
...
def write_assets(
    ...
    css_path = output_dir / "pagevault.css"
    js_path = output_dir / "pagevault.js"
