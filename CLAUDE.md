...
```
lockhtml mark <paths> [-r] [-s SELECTOR]... [--hint] [--remember] [--title]
lockhtml lock <paths> [-r] [-d DIR] [-p PASSWORD] [-c CONFIG] [--dry-run] [--css]
lockhtml unlock <paths> [-r] [-d DIR] [-p PASSWORD] [-u USERNAME] [-c CONFIG] [--dry-run]
lockhtml sync <paths> [-r] [-c CONFIG] [--dry-run] [--rekey]
lockhtml config init|show|where
lockhtml wrap file <path> [-p PASSWORD] [-c CONFIG] [-o OUTPUT]
lockhtml wrap site <dir> [-p PASSWORD] [-c CONFIG] [-o OUTPUT] [--entry ENTRY]
```
